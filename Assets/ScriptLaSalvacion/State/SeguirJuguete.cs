...
public class SeguirJuguete : Humano
{
    ...
    private void OnArrival()
    {
        ...
        Debug.Log("He llegado al destino. Empieza la lógica de SeguirJuguete.");
    }
    ...
    public override void Execute()
    {
        ...
        // Si el juguete sigue visible, actualizar posición constantemente
        currentToy = _iaEye.ViewToy.transform;
        ...
        // Resto de condiciones (energía, WC, sueño...)
